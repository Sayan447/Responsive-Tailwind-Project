  ...
  return (
    <div className='flex justify-between'>
      <div className='flex justify-center items-center gap-3'>
        ...
        <button className='bg-gradient-to-r from-orange-400 to-red-400 text-xs text-white px-2.5 py-1.5 rounded-2xl'>Hoster is hirring</button>
      </div>
      ...
      <div  className='hidden lg:flex justify-between items-center font-lato gap-6'>
        ...
        <button className='rounded-md px-4 py-3 bg-blue-400 hover:bg-blue-700 text-white'>Join us</button>
      </div>
