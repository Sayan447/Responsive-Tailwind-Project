  ...
  return (
    <div className='space-y-4 lg:flex'>
        ...
        <div className='lg:flex-1 lg:order-1'>
            ...
            <p className='font-lato text-gray-400'>With Hoster , grt your website up and running in no less than 5 minutes with the most competitive priceing package average</p>
            <form action="" className='flex flex-col gap-4 md:flex-row'>
                <input className='rounded-md px-4 py-3 placeholder:text-gray-600' type="email" placeholder='Enter Email address' />
